...
Source: https://ai.google.dev/gemini-api/docs/pricing.md
FetchMode: markdown
TimeoutSeconds: 20
Tags: pricing
...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/v8b8ef181e1dc913802015af34f7ea88ee446e0cb5daec5c977ac4c46a7a372bd/googledevai/images/touchicon-180-new.png"><link rel="canonical" href="https://ai.google.dev/gemini-api/docs/pricing"><link rel="search" type="application/opensearchdescription+xml"
...
<meta property="og:title" content="Gemini Developer API pricing &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers"><meta name="description" content="Gemini Developer API Pricing">
  <meta property="og:description" content="Gemini Developer API Pricing"><meta property="og:url" content="https://ai.google.dev/gemini-api/docs/pricing"><meta property="og:image" content="https://ai.google.dev/static/site-assets/images/share-gemini-api-2.png">
...
<div class="pricing-container">
  <div class="pricing-cards">
      ...
      <div class="pricing-card">
          ...
          <p class="plan-description">For large-scale deployments with custom needs for security, support, and compliance, powered by <a href="https://cloud.google.com/vertex-ai">Vertex AI</a>.</p>
          <ul class="features">
...
<div class="models-section">
    <div class="heading-group">
        ...
        <em><code translate="no" dir="ltr">gemini-3.1-pro-preview</code> and <code translate="no" dir="ltr">gemini-3.1-pro-preview-customtools</code></em>
    </div>
    <p>
...
<p>The latest performance, intelligence, and usability improvements to the best
...
<section><h3 id="standard" data-text="Standard" tabindex="-1">Standard</h3><table class="pricing-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Not available</td>
      <td>5,000 prompts per month (free), then $14 / 1,000 search queries</td>
    </tr>
    <tr>
...
<section><h3 id="batch" data-text="Batch" tabindex="-1">Batch</h3><table class="pricing-table">
  ...
  <tbody>
    ...
    <tr>
      <td>Grounding with Google Search<sup>*</sup></td>
      <td>Not available</td>
      <td>1,500 RPD (free), then $14 / 1,000 search queries</td>
    </tr>
    <tr>
      <td>Grounding with Google Maps</td>
      <td>Not available</td>
...
<div class="models-section">
    <div class="heading-group">
        ...
        <em><code translate="no" dir="ltr">gemini-3.1-flash-lite-preview</code></em>
    </div>
    <p>
        <a href="https://aistudio.google.com/prompts/new_chat?model=gemini-3.1-flash-lite-preview" class="button button-primary ais">Try it in Google AI Studio</a>
    </p>
</div>

<p>Our most cost-efficient model, optimized for high-volume agentic tasks,
translation, and simple data processing.</p>

<p>Preview models may change before becoming stable and have more restrictive rate
limits.</p>
<div class="ds-selector-tabs" data-ds-scope="code-sample">
...
<div class="models-section">
    <div class="heading-group">
        <h2 id="gemini-3.1-flash-image-preview" data-text="Gemini 3.1 Flash Image Preview 🍌" tabindex="-1">Gemini 3.1 Flash Image Preview 🍌</h2>
        <em><code translate="no" dir="ltr">gemini-3.1-flash-image-preview</code></em>
    </div>
    <p>
        <a href="https://aistudio.google.com/prompts/new_chat?model=gemini-3.1-flash-image-preview" class="button button-primary ais">Try it in Google AI Studio</a>
    </p>
</div>
...
<section><h3 id="standard_2" data-text="Standard" tabindex="-1">Standard</h3><table class="pricing-table">
  ...
  <tbody>
    ...
    <tr>
      <td>Grounding with Google Search<sup>**</sup></td>
      <td>Not available</td>
      <td>5,000 prompts per month (free), then $14 / 1,000 search queries for text and image-based grounding.</td>
    </tr>
    <tr>
      <td>Used to improve our products</td>
      <td><a href="/gemini-api/terms">Yes</a></td>
...
<div class="models-section">
    <div class="heading-group">
        ...
        <em><code translate="no" dir="ltr">gemini-3-flash-preview</code></em>
    </div>
    <p>
...
<p>Our most intelligent model built for speed, combining frontier intelligence with
...
<section><h3 id="batch_3" data-text="Batch" tabindex="-1">Batch</h3><table class="pricing-table">
  ...
  <tbody>
    ...
    <tr>
      <td>Context caching price</td>
      <td>Not available</td>
      <td><em>Same as Standard, Batch pricing not yet implemented</em><br>
...
<div class="models-section">
    <div class="heading-group">
        <h2 id="gemini-3-pro-image-preview" data-text="Gemini 3 Pro Image Preview 🍌" tabindex="-1">Gemini 3 Pro Image Preview 🍌</h2>
        <em><code translate="no" dir="ltr">gemini-3-pro-image-preview</code></em>
    </div>
    <p>
        <a href="https://aistudio.google.com?model=gemini-3-pro-image-preview" class="button button-primary ais">Try it in Google AI Studio</a>
    </p>
</div>
...
<p>Our smallest and most cost effective model, built for at scale usage.</p>
<div class="ds-selector-tabs" data-ds-scope="code-sample">
...
<div class="models-section">
    <div class="heading-group">
        <h2 id="gemini-2.5-flash-lite-preview" data-text="Gemini 2.5 Flash-Lite Preview" tabindex="-1">Gemini 2.5 Flash-Lite Preview</h2>
        <em><code translate="no" dir="ltr">gemini-2.5-flash-lite-preview-09-2025</code></em>
    </div>
    <p>
        <a href="https://aistudio.google.com?model=gemini-2.5-flash-lite-preview-09-2025" class="button button-primary ais">Try it in Google AI Studio</a>
    </p>
</div>

<p>The latest model based on Gemini 2.5 Flash lite optimized for cost-efficiency,
high throughput and high quality.</p>
<div class="ds-selector-tabs" data-ds-scope="code-sample">
...
<div class="models-section">
    <div class="heading-group">
        ...
        <em><code translate="no" dir="ltr">gemini-2.5-flash-native-audio-preview-12-2025</code></em>
    </div>
    <p>
...
<div class="models-section">
    <div class="heading-group">
        <h2 id="gemini-2.5-flash-image" data-text="Gemini 2.5 Flash Image 🍌" tabindex="-1">Gemini 2.5 Flash Image 🍌</h2>
        <em><code translate="no" dir="ltr">gemini-2.5-flash-image</code></em>
    </div>
    <p>
...
<div class="models-section">
    <div class="heading-group">
        ...
        <em><code translate="no" dir="ltr">gemini-2.5-flash-preview-tts</code></em>
    </div>
    <p>
...
<div class="models-section">
    <div class="heading-group">
        ...
        <em><code translate="no" dir="ltr">gemini-2.5-pro-preview-tts</code></em>
    </div>
    <p>
        <a href="https://aistudio.google.com/generate-speech" class="button button-primary ais">Try it in Google AI Studio</a>
    </p>
...
<div class="models-section">
    <div class="heading-group">
        <h2 id="gemini-2.0-flash" data-text="Gemini 2.0 Flash" tabindex="-1">Gemini 2.0 Flash</h2>
        <em><code translate="no" dir="ltr">gemini-2.0-flash</code></em>
    </div>
</div>

<aside class="warning">
  <b>Warning:</b> Gemini 2.0 Flash is <a href="/gemini-api/docs/deprecations">deprecated</a> and will be shut down June 1, 2026. Migrate to <a href="/gemini-api/docs/models">a newer model</a> to avoid service disruption.
</aside>
<div class="ds-selector-tabs" data-ds-scope="code-sample">
<section><h3 id="standard_12" data-text="Standard" tabindex="-1">Standard</h3><table class="pricing-table">
  ...
  <tbody>
    <tr>
      <td>Input price</td>
      <td>Free of charge</td>
      <td>$0.10 (text / image / video)<br>$0.70 (audio)</td>
    </tr>
    <tr>
      <td>Output price</td>
      <td>Free of charge</td>
    ...
    <tr>
      <td>Context caching price</td>
      <td>Free of charge</td>
      <td>$0.025 / 1,000,000 tokens (text/image/video)<br>$0.175 / 1,000,000 tokens (audio)</td>
    </tr>
    <tr>
      <td>Context caching (storage)</td>
      <td>Not available</td>
      <td>$1.00 / 1,000,000 tokens per hour</td>
    </tr>
    <tr>
      <td>Image generation pricing</td>
      <td>Not available (<a href="/gemini-api/docs/deprecations#gemini-2.0-models">shut down</a>)</td>
      <td>Not available (<a href="/gemini-api/docs/deprecations#gemini-2.0-models">shut down</a>)</td>
    </tr>
    <tr>
      <td>Tuning price</td>
    ...
    <tr>
      <td>Grounding with Google Search</td>
      <td>Free of charge, up to 500 RPD</td>
      <td>1,500 RPD (free), then $35 / 1,000 grounded prompts</td>
    </tr>
    <tr>
      <td>Grounding with Google Maps</td>
...
<section><h3 id="batch_12" data-text="Batch" tabindex="-1">Batch</h3><table class="pricing-table">
  ...
  <tbody>
    <tr>
      <td>Input price</td>
      <td>Not available</td>
      <td>$0.05 (text / image / video)<br>$0.35 (audio)</td>
    </tr>
    <tr>
      <td>Output price</td>
      <td>Not available</td>
...
<div class="models-section">
    <div class="heading-group">
        <h2 id="gemini-2.0-flash-lite" data-text="Gemini 2.0 Flash-Lite" tabindex="-1">Gemini 2.0 Flash-Lite</h2>
        <em><code translate="no" dir="ltr">gemini-2.0-flash-lite</code></em>
    </div>
</div>

<aside class="warning">
  <b>Warning:</b> Gemini 2.0 Flash-Lite is <a href="/gemini-api/docs/deprecations">deprecated</a> and will be shut down June 1, 2026. Migrate to <a href="/gemini-api/docs/models">a newer model</a> to avoid service disruption.
</aside>
<div class="ds-selector-tabs" data-ds-scope="code-sample">
...
<div class="models-section">
    <div class="heading-group">
        <h2 id="imagen-4" data-text="Imagen 4" tabindex="-1">Imagen 4</h2>
        <em><code translate="no" dir="ltr">imagen-4.0-generate-001</code>, <code translate="no" dir="ltr">imagen-4.0-ultra-generate-001</code>, <code translate="no" dir="ltr">imagen-4.0-fast-generate-001</code></em>
    </div>
    <p>
        <a href="https://aistudio.google.com/generate-image" class="button button-primary ais">Try it in Google AI Studio</a>
    </p>
</div>

<p>Our latest image generation model, with significantly better text rendering and
...
<table class="pricing-table">
  ...
  <thead>
    <tr>
      <th></th>
      <th scope="col">Free Tier</th>
      <th scope="col">Paid Tier, per Image in USD</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>Imagen 4 Fast image price</td>
      <td>Not available</td>
      <td>$0.02</td>
    </tr>
    <tr>
      <td>Imagen 4 Standard image price</td>
      <td>Not available</td>
      <td>$0.04</td>
    </tr>
    <tr>
      <td>Imagen 4 Ultra image price</td>
      <td>Not available</td>
      <td>$0.06</td>
    </tr>
    <tr>
...
<div class="models-section">
    <div class="heading-group">
        ...
        <em><code translate="no" dir="ltr">veo-3.1-generate-preview</code>, <code translate="no" dir="ltr">veo-3.1-fast-generate-preview</code></em>
    </div>
    <p>
...
<p>Our latest video generation model, available to developers on the
paid tier of the Gemini API.</p>
...
<table class="pricing-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Not available</td>
      <td>$0.15 (720p and 1080p)<br>$0.35 (4k)</td>
    </tr>
    <tr>
      <td>Used to improve our products</td>
      <td><a href="/gemini-api/terms">Yes</a></td>
...
<div class="models-section">
    <div class="heading-group">
        <h2 id="veo-3" data-text="Veo 3" tabindex="-1">Veo 3</h2>
        <em><code translate="no" dir="ltr">veo-3.0-generate-001</code>, <code translate="no" dir="ltr">veo-3.0-fast-generate-001</code></em>
    </div>
    <p>
        <a href="https://deepmind.google/models/veo/" class="button button-primary ais">Try Veo 3</a>
    </p>
</div>

<p>Our stable video generation model, available to developers on the
paid tier of the Gemini API.</p>
...
<table class="pricing-table">
  ...
  <tbody>
    <tr>
      <td>Veo 3 Standard video with audio price (default)</td>
      <td>Not available</td>
      <td>$0.40</td>
    </tr>
    <tr>
      <td>Veo 3 Fast video with audio price (default)</td>
      <td>Not available</td>
      <td>$0.15</td>
    </tr>
    <tr>
...
<div class="models-section">
    <div class="heading-group">
        <h2 id="veo-2" data-text="Veo 2" tabindex="-1">Veo 2</h2>
        <em><code translate="no" dir="ltr">veo-2.0-generate-001</code></em>
    </div>
    <p>
        <a href="/gemini-api/docs/video" class="button button-primary ais">Try the API</a>
    </p>
</div>

<p>Our state-of-the-art video generation model, available to developers on the
paid tier of the Gemini API.</p>
...
<div class="models-section">
    <div class="heading-group">
        <h2 id="gemini-embedding-2" data-text="Gemini Embedding 2 Preview" tabindex="-1">Gemini Embedding 2 Preview</h2>
        <em><code translate="no" dir="ltr">gemini-embedding-2-preview</code></em>
    </div>
    <p>
...
<div class="models-section">
    <div class="heading-group">
        ...
        <em><code translate="no" dir="ltr">gemini-embedding-001</code></em>
    </div>
    <p>
        <a href="/gemini-api/docs/embeddings" class="button button-primary ais">Try the API</a>
    </p>
...
<p>Our Gemini Embeddings model for text-only use cases, available to developers on the free and paid tiers of the Gemini API.</p>
<div class="ds-selector-tabs" data-ds-scope="code-sample">
...
<div class="models-section">
    <div class="heading-group">
        <h2 id="gemini-robotics-er" data-text="Gemini Robotics-ER 1.5 Preview" tabindex="-1">Gemini Robotics-ER 1.5 Preview</h2>
        <em><code translate="no" dir="ltr">gemini-robotics-er-1.5-preview</code></em>
    </div>
    <p>
        <a href="https://aistudio.google.com?model=gemini-robotics-er-1.5-preview" class="button button-primary ais">Try it in Google AI Studio</a>
    </p>
</div>
...
<div class="models-section">
    <div class="heading-group">
        ...
        <em><code translate="no" dir="ltr">gemini-2.5-computer-use-preview-10-2025</code></em>
    </div>
</div>
...
<div class="models-section">
    <h2 id="gemma-3" data-text="Gemma 3" tabindex="-1">Gemma 3</h2>
</div>
...
<div class="models-section">
    <h2 id="gemma-3n" data-text="Gemma 3n" tabindex="-1">Gemma 3n</h2>
</div>

<p>Our open model built for efficient performance on everyday devices like mobile
phones, laptops, and tablets.</p>
  ...
  <tbody>
    <tr>
      ...
      <td>Gemini 2.5 models:<br>
          ...
          Gemini 3 models:<br>
          5,000 prompts per month (free), then $14 / 1,000 search queries</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Not available</td>
      <td>See <a href="#gemini-2.5-computer-use-preview-10-2025">Gemini 2.5 Computer Use Preview</a> pricing table.</td>
    </tr>
    <tr>
...
<p>[*] Google AI Studio usage is free of charge in all <a href="/gemini-api/docs/available-regions">available regions</a>.
See <a href="/gemini-api/docs/billing">Billing FAQs</a> for details.</p>

<p>[**] Prices may differ from the prices listed here and the prices offered on
Vertex AI. For Vertex prices, see the <a href="https://cloud.google.com/vertex-ai/generative-ai/pricing">Vertex AI pricing page</a>.</p>

<p>[***] If you are using <a href="/gemini-api/docs/grounding">dynamic retrieval</a> to
...
Costs for Gemini always apply. Rate limits are subject to change.</p>
...
<table class="pricing-table">
  ...
  <tbody>
    <tr>
      ...
      <td>All model inference is charged at standard <a href="#gemini-3-pro-preview">Gemini 3 Pro</a> list rates,
